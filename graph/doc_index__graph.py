...
命令行：`python -m graph.doc_index__graph` → 写出 logs/analysis/文档索引卡.{md,json}
"""
...
HUB_DIR = _hub_root()
OUT_MD = Path(__file__).resolve().parents[1] / "logs" / "analysis" / "文档索引卡.md"
OUT_JSON = Path(__file__).resolve().parents[1] / "logs" / "analysis" / "文档索引卡.json"
