...
def llm_mode() -> str:
    ...
    if mode in ("api", "agent"):
        return mode
    try:
        from ai.ai_client__ai import load_chain_config
...
def _facts_of(doc_key: str) -> list[dict]:
    import l1.l1_facts__fact_list as l1_facts__fact_list
...
def _branch_rule_text() -> str:
    ...
    try:
        from desens.desens_legend__desens import branch_rule
...
def _judge_candidate(cand: dict) -> tuple[dict | None, str, bool]:
    ...
    from ai.ai_client__ai import complete, load_chain_config
