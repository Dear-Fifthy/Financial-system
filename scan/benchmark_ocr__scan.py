...
文件位置：scan/benchmark_ocr__scan.py（按层归入子目录）。
用法：
    python -m scan.benchmark_ocr__scan [PDF路径] [页数]
...
from infra.monitor__infra import gpu_snapshot, start_performance_monitor, stop_performance_monitor  # noqa: E402
from scan.pdf_native_extractor__scan import render_page_to_image  # noqa: E402
from scan.scanner_core__scan import OCR_ENGINE, predict_safely, resolve_ocr_device  # noqa: E402
...
def main() -> int:
    ...
    tmp_dir = Path(__file__).resolve().parents[1] / "output" / "_bench_tmp"
