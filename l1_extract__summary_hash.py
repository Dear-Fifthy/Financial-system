...
def project_hub_file(
    ...
    *,
    ...
    """
    from database_serv__infra import get_admin_connection
    from ai_guard__desens import require_hub_file   # AI 输入守卫：L1 的概括走 AI，只允许 hub/
    ...
    facts: list[dict] = []
    try:
        import l1_facts__fact_list as _facts
...
def project_folder(folder: str | Path, *, pattern: str = "*.json") -> list[dict]:
    ...
    """
    from ai_guard__desens import require_hub_dir
