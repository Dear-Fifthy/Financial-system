...
LOGO_DIR = Path(__file__).resolve().parent / "logs" / "project"
...
def _ensure_tables() -> None:
    ...
    from database_serv__infra import _ensure_entity_table   # 项目编号走实体映射表机制
...
def list_entries(
    ...
    *,
    ...
    from database_serv__infra import require_permission
